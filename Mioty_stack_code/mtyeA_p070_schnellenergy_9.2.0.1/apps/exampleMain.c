...
uint8_t configEntryFlag=0x16,configEntryFlag1;
float tmp10750TempAsFloatCelsius;
...
/*  spi_init();
  ...
  int32_t tmp10750Temp;
  tmp10750Temp = TMP1075_read(TMP1075_0);
  tmp10750TempAsFloatCelsius = TMP1075_toFloatCelsius(tmp10750Temp);
